  ...
  return (
    <div className="policy-controls">
      ...
      <p className="policy-controls-intro">
        Use the tools below to steer the economy. Each option has a <strong>?</strong> â€” hover over it to learn what it does.
      </p>
      <form onSubmit={handleSubmit}>
        ...
        {/* â”€â”€ EASY MODE: Quick-set sliders only â”€â”€ */}
        {mode === 'easy' && (
        ...
        {/* â”€â”€ ADVANCED MODE or fine-tune toggle â”€â”€ */}
        {mode === 'easy' && (
          <button
            type="button"
        ...
        {/* â”€â”€ Fiscal & Monetary (no duplicates) â”€â”€ */}
        ...
        {/* â”€â”€ Regulation & Coordination â”€â”€ */}
