...
/**
 * AI Displaced â€” Tech worker replaced by AI (25+ decisions)
...
"Restructuring," they say. "Efficiency initiatives." The company is integrating AI agents that can now handle multi-step work â€” research, analysis, code, customer support â€” without sleep, sick days, or health insurance. Your role has been "consolidated."
...
Your savings will last six months if you're careful. Rent in your city has not fallen. The job boards are full of postings that want "AI-assisted" candidates â€” people who can prompt and review, not build. The salaries are half what you had.
...
Varoufakis calls it technofeudalism: cloud capital extracts value while you provide unpaid data and precarious labor. The platforms â€” Uber, DoorDash, TaskRabbit â€” are the new fiefdoms. You can sign up for gig work to extend your runway. Or you can keep searching for something "real."
...
What do you do?`,
  ...
  },
  {
    phase: 1,
    title: 'The Interview',
    narrative: `You land an interview. The role is "AI Operations Associate" â€” you'll train models, review outputs, and "ensure quality." The pay is $65,000. A year ago, this would have been a junior role at $95,000. The hiring manager says they've "right-sized" the team. You'll be one of three humans overseeing work that used to require twenty.

Jodi Dean writes about neo-feudalism: the parcelization of sovereignty, where corporations and platforms fragment the old social contract. This job would put you inside the machine that replaced you â€” maintaining the very systems that made you redundant.
...
Do you take it, or walk away?`,
  ...
  },
  {
    ...
    narrative: `Someone from your old company started a Slack for the "alumni." It's not official â€” just displaced workers sharing leads, venting, and sometimes pooling resources. A few have formed a mutual aid fund: small grants for people who can't make rent. They're calling it "solidarity, not charity."

Analysts suggest that when high earners lose jobs, the consumption hit is lagged but deep â€” savings buffers let you maintain the appearance of normalcy for a few quarters. Then the behavioral shift kicks in. You're not there yet, but you see it coming.
...
Do you contribute to the fund, take from it, or stay on the sidelines?`,
  ...
  },
  {
    ...
    narrative: `Your landlord sends a notice. Rent is going up 12%. Inflation has eased from its peak, they say, but "market rates" have moved. Your unemployment benefits ran out two months ago. The job market has not recovered â€” white-collar openings keep falling while blue-collar and healthcare hold steady. The churn is in the jobs that write memos and approve budgets.

You could move to a cheaper neighborhood. You could get a roommate. You could dip into the 401(k) â€” the penalty hurts, but you need to eat. Each option has a cost.
...
What do you do?`,
  ...
  },
  {
    phase: 2,
    title: 'The Recruiter',
    narrative: `A recruiter reaches out. The role is at a "AI-native" startup â€” they've never had human PMs; they're hiring their first. The pitch: you'll "bridge the gap" between the models and the business. The salary is $90,000, with equity that might be worth something if they don't get acquired by a hyperscaler and shut down.
...
You're not delinquent yet. But you're one shock away. You could try to refinance â€” rates have come down. You could sell and downsize. You could try to rent a room to a stranger.
...
What do you do?`,
  ...
  },
  {
    ...
    narrative: `Someone from the alumni Slack has organized an in-person meetup. "Tech Workers United" â€” they're talking about forming a union or at least a collective bargaining association. The room is full of people like you: displaced, angry, unsure what comes next.

Varoufakis argues that cloud capital creates "cloud serfs" â€” users and workers who sustain the system without fair compensation. The only counter is collective action. But tech workers have never unionized at scale. And the companies have the leverage: they can offshore, automate, or simply wait you out.
...
Do you join, or stay away?`,
  ...
  },
  {
    phase: 3,
    title: 'The Offer',
    narrative: `You have an offer. It's not what you wanted â€” $75,000, "AI-augmented" role, no remote option. But it's a paycheck. The hiring manager says they're "building for the future." You'll be one of the humans "in the loop," at least for now.

Analysts suggest that for every new role AI created â€” prompt engineers, safety researchers â€” it rendered dozens obsolete. The new roles paid a fraction of the old ones. You can take this and rebuild, or hold out for something better. The market has not been kind to those who hold out.
...
What do you do?`,
  ...
  },
  {
    ...
    narrative: `A former colleague is building something on the side â€” a cooperative that matches displaced tech workers with small businesses that can't afford enterprise AI. The model: humans do the work AI can't yet do well (relationship-building, nuance, judgment), and they split the revenue. No VC, no platform taking 30%.

It's early. It might fail. But it's a different kind of bet â€” on human value that hasn't been fully commodified. Dean writes that without organized political struggle, the system could evolve toward neo-feudalism rather than something better. This could be a seed of something else.
...
Do you get involved?`,
  ...
  },
  {
    ...
    narrative: `You haven't slept well in months. The anxiety is constant. Your doctor mentions that the rate of depression and substance use among displaced white-collar workers has spiked. The lag between job loss and the full behavioral impact is one of the reasons the crisis was hard to see coming â€” people maintained the appearance of normalcy until they couldn't.

You could try therapy â€” there are sliding-scale options. You could lean on the mutual aid group. You could push through and hope it gets better when you land something. The first two cost time or money. The third costs something else.
...
What do you do?`,
  ...
  },
  {
    ...
    narrative: `Congress is finally holding hearings. UBI, retraining, a jobs guarantee â€” the proposals are on the table. The government's response has lagged, as it always does. Some warn that lack of a comprehensive plan could accelerate a deflationary spiral. You could add your voice: write to your representative, join a campaign, testify if they invite displaced workers.
...
What do you do?`,
...

  {
    phase: 4,
    title: 'The Reckoning',
    narrative: `A year has passed. You've made it this far. The economy has not recovered the way the optimists hoped. The "creative destruction" narrative â€” that AI would destroy jobs and create better ones â€” has not played out. The intelligence premium has been repriced. You've seen friends downshift, move in with family, or leave the industry entirely.
...
What do you take from this?`,
  ...
  },
  {
    ...
    narrative: `You have a choice about what comes next. The old economy â€” the one that paid you to think, to analyze, to build â€” is not coming back. The question is what you build in its place.
...
But you're still here. You made choices. Some worked, some didn't. The question now is what you leave behind â€” for yourself, and for those who come after.
...
const endings: LongFormEnding[] = [
  {
    ...
    endingNarrative: `You made it through. You kept your health, your sense of worth, and your connection to others. The economy changed â€” the intelligence premium was repriced, the old contract was broken â€” but you did not break. You built solidarity where you could. You adapted where you had to. The struggle continues, but so do you.`,
  },
  {
    id: 'partial',
  ...
  },
  {
    ...
    endingType: 'defeat',
    title: 'The Spiral',
    endingNarrative: `The spiral won. The savings ran out. The jobs didn't come. The system that replaced you with machines had no plan for what came next. You're not alone â€” millions have walked this path. Some were right: when human intelligence is repriced to zero, the feedback loop has no natural brake. But the fight for dignity, for solidarity, for a different future â€” that continues.`,
  },
];
